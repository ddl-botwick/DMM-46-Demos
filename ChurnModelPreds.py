...
churn_inputs_and_preds['Gender']=np.random.randint(0,2, churn_inputs_and_preds.shape[0])
mymap = {0:'M',1: 'F'}
...
ax = sns.barplot(x = ['F', 'M'], y = churn_inputs_and_preds.groupby('Gender').mean()['churn_Y'])
